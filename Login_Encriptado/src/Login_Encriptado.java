...
LoginPrueba.setBounds ( ss.width / 2 - frameSize.width / 2, ss.height / 2 - frameSize.height / 2,
...
public Login_Encriptado()
  {
      super("CHATCONRIQUEZ: INICIO DE SESION");
        ...
        setResizable(false); 
        inicializarPanelFondo();          //ORDENADO PARA SU LOGIN
  ...
  private void inicializarPanelBotones(){
       ...
       //Añado botones Guardar
        ...
        if (email.isEmpty()||clave.isEmpty()){
                errorEmail.setText("Ingrese el email");
                textFieldEmail.requestFocus();
                errorClave.setText("Ingrese la contraseña");
                passwordFieldContraseña.requestFocus();
                        }
        else{
              if(email.equals("Marco@gmail.com")&&clave.equals("Marco123")||email.equals("Eduardo@gmail.com")&&clave.equals("Eduardo123")){
              errorEmail.setText("");
              File archivo;
...
//              JOptionPane.showMessageDialog(null, main.Desencriptar(encriptada));
              ...
              errorClave.setText("");
              errorEmail.setText("Su usuario y contraseña son incorrectos");
            }     
                }
                }
        });       
